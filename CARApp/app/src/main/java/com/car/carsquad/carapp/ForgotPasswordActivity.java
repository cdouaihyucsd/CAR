...
public class ForgotPasswordActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Keep track of the forgot password task to ensure we can cancel it if requested.
     */
    ...
    private void attemptLogin() {
        ...
        // Store values at the time of the forgot password attempt.
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new ForgotPasswordTask(email);
    ...
    /**
     * Represents an asynchronous forgot password task used to authenticate
     * the user.
     */
    public class ForgotPasswordTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(mEmail)) {
                    // TODO: Account exists, let user enter new password

                    return true;
                }
            }
            // TODO: Account doesn't exist, inform user (maybe entered wrong email)
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mEmailView.setError(getString(R.string.error_account_doesnt_exist));
