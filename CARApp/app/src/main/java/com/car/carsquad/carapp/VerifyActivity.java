...
/**
 * A very screen that offers the user to verify their email and be sent register code.
 */
public class VerifyActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Keep track of the verify task to ensure we can cancel it if requested.
     */
    ...
    /**
     * Attempts to verify the account specified by the verify form.
     * If there are form errors (invalid email, missing fields, etc.), the
     * errors are presented and no actual verify attempt is made.
     */
    private void attemptVerify() {
        ...
        if (cancel) {
            ...
            // perform the user verify attempt.
            showProgress(true);
            mAuthTask = new UserVerifyTask(email);
    ...
    /**
     * Represents an asynchronous verify task used to authenticate
     * the user.
     */
